...
To get started, clone the project if you have access or just forked it and then please install all the dependencies via `yarn` or `npm` Make sure to change directory to
`rentech/`
